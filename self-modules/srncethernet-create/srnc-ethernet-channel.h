...
#ifndef NS3_CLASS_SRNC03_POINT_TO_POINT_CHANNEL
#define NS3_CLASS_SRNC03_POINT_TO_POINT_CHANNEL
...
class ns3_ClassSRNC01_PointToPointNetDevice_SRNCEthernet;
class Packet;
 ...
 * \see TransmitStart
 */
class ns3_ClassSRNC03_PointToPointChannel : public Channel 
{
public:
  /**
   ...
   */
  ns3_ClassSRNC03_PointToPointChannel ();

  /**
   * \brief Attach a given netdevice to this channel
   * \param device pointer to the netdevice to attach to the channel
   */
  void Attach (Ptr<ns3_ClassSRNC01_PointToPointNetDevice_SRNCEthernet> device);

  /**
   * \brief Transmit a packet over this channel
   * \param p Packet to transmit
   * \param src Source ns3_ClassSRNC01_PointToPointNetDevice_SRNCEthernet
   * \param txTime Transmit time to apply
   * \returns true if successful (currently always true)
   */
  virtual bool TransmitStart (Ptr<const Packet> p, Ptr<ns3_ClassSRNC01_PointToPointNetDevice_SRNCEthernet> src, Time txTime);
  ...
  /**
   * \brief Get ns3_ClassSRNC01_PointToPointNetDevice_SRNCEthernet corresponding to index i on this channel
   * \param i Index number of the device requested
   * \returns Ptr to ns3_ClassSRNC01_PointToPointNetDevice_SRNCEthernet requested
   */
  Ptr<ns3_ClassSRNC01_PointToPointNetDevice_SRNCEthernet> GetPointToPointDevice (std::size_t i) const;
...
protected:
   ...
   * \returns Ptr to ns3_ClassSRNC01_PointToPointNetDevice_SRNCEthernet source for the 
   * specified link
   */
  Ptr<ns3_ClassSRNC01_PointToPointNetDevice_SRNCEthernet> GetSource (uint32_t i) const;

  /**
   * \brief Get the net-device destination
   * \param i the link requested
   * \returns Ptr to ns3_ClassSRNC01_PointToPointNetDevice_SRNCEthernet destination for 
   * the specified link
   */
  Ptr<ns3_ClassSRNC01_PointToPointNetDevice_SRNCEthernet> GetDestination (uint32_t i) const;
...
public:
    ...
    Ptr<ns3_ClassSRNC01_PointToPointNetDevice_SRNCEthernet> m_src;   //!< First NetDevice
    Ptr<ns3_ClassSRNC01_PointToPointNetDevice_SRNCEthernet> m_dst;   //!< Second NetDevice
  };
