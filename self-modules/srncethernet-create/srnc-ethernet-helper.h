 ...
 */
#ifndef NS3_CLASS_SRNC00_POINT_TO_POINT_HELPER
#define NS3_CLASS_SRNC00_POINT_TO_POINT_HELPER
...
/**
 * \brief Build a set of ns3_ClassSRNC01_PointToPointNetDevice_SRNCEthernet objects
 *
 * Normally we eschew multiple inheritance, however, the classes 
 * PcapUserHelperForDevice and AsciiTraceUserHelperForDevice are
 * "mixins".
 */
class ns3_ClassSRNC00_PointToPointHelper : public PcapHelperForDevice,
	                   public AsciiTraceHelperForDevice
{
public:
  /**
   * Create a ns3_ClassSRNC00_PointToPointHelper to make life easier when creating point to
   * point networks.
   */
  ns3_ClassSRNC00_PointToPointHelper ();
  virtual ~ns3_ClassSRNC00_PointToPointHelper () {}
   ...
   * ns3_ClassSRNC01_PointToPointNetDevice_SRNCEthernet created through ns3_ClassSRNC00_PointToPointHelper::Install.
   */
   ...
   *
   * Set these attributes on each ns3::ns3_ClassSRNC01_PointToPointNetDevice_SRNCEthernet created
   * by ns3_ClassSRNC00_PointToPointHelper::Install
   */
   ...
   * attributes configured by ns3_ClassSRNC00_PointToPointHelper::SetChannelAttribute,
   * then, for each node in the input container, we create a 
   * ns3::ns3_ClassSRNC01_PointToPointNetDevice_SRNCEthernet with the requested attributes, 
